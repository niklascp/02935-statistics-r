...
\path[draw=drawColor,line width= 0.6pt,line join=round] ( 65.43, 45.09) --
	( 67.49, 43.13) --
	( 69.55, 42.34) --
	( 71.60, 42.21) --
	( 73.66, 44.45) --
...
\node[text=drawColor,rotate= 90.00,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.96] at ( 12.61,104.65) {Check In Count};
\end{scope}
\end{tikzpicture}
